...
for channel = 1:num_channels
    ...
    plot(t, gather(emg_channels(:, channel)));
...
for i = 1:num_channels
    ...
    plot(freqs, gather(fft_values(:, i)));
...
for i = 1:num_channels
    subplot(num_channels, 1, i);
    plot(freqs, gather(normalized_fft_values(:, i)));
...
disp(gather(mean_freq_normalized));

disp('Median Frequency (Hz) per Channel (Normalized):');
disp(gather(median_freq_normalized));
